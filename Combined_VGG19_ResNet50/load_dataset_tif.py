...
def load_preprocess_image(img_path_train):
    ...
    img_tensor_train=tf.image.resize(img_tensor_train, [64, 64]) # 將圖片 resize 成 256*256
    ...
    #標準化
    img_train=img_tensor_train/args.standard_param # 65535 # 255
   # print (args.standard_param)
    return img_train
...
#args.band_set = "4band_256_8bit"

def call():
    #band_set = "4band_256_8bit"

    train_x, train_y, label_dict = read_img("../../" + args.band_set + "/train_set/")
    train_count = len(train_x)
    #print('train count is:')
    print(train_count)
    test_x, test_y, label_dict = read_img("../../" + args.band_set + "/test_set/")
    test_count = len(test_x)
    val_x, val_y, label_dict = read_img("../../" + args.band_set + "/validation_set/")
    val_count = len(val_x)
