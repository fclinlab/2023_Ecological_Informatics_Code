...
classification_report_out = "./Results/outcome_pictures/" + args.band_set + "/2022_tree_ResNet50_Original.txt"
...
# modify version2
#band_num = 4
conv_base=keras.applications.ResNet50(weights=None,include_top=False, input_shape=(64, 64, args.band_num)) # original version
conv_base.summary()
...
modelPath = './Results/outcome_pictures/' + args.band_set + '/ResNet50_model.h5'

model.save(modelPath)  # creates a HDF5 file 'VGG19_model.h5'

f.write("ResNet50 Training Time: {}:{:.2f}".format(mins, secs)+"\n")
...
def plot_learning_curves(history):
    ...
    #curves_img_path = './Results/outcome_pictures/' + args.band_set + '/ResNet50_Original_7_curves.png'
    curves_img_path = './Results/outcome_pictures/' + args.band_set + '/ResNet50_Original_7_curves'
    i = 0
...
print("ResNet50 Testing Time: {}:{:.2f}".format(mins, secs),(model.evaluate(test_dataset,verbose=0)))

f.write("ResNet50 Testing Time: {}:{:.2f}".format(mins, secs)+"\n")
...
csv_path = './Results/outcome_pictures/' + args.band_set + '/2022_ResNet50_Original_confusion_matrix.csv'
...
def ConfusionMatrixPlot(confmatrix_Input):    
   ...
   #cb.set_label('Numbers of Predict',fontsize = 15)
    #Confusion_img_path = './Results/outcome_pictures/' + args.band_set + '/ResNet50_Original_7.png'
    Confusion_img_path = './Results/outcome_pictures/' + args.band_set + '/ResNet50_Original_7'
    i = 0
